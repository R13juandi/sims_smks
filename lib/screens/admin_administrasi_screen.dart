...
class _AdminDashboardState extends State<AdminDashboard>
  ...
  // 🔥 INDEX HANYA ADA 0 DAN 1 SEKARANG
  int _currentIndex = 0;
  ...
  Widget build(BuildContext context) {
    ...
    // 🔥 HANYA 2 TAB AGAR UI LEBIH CLEAN & SIMPLE (TAB KE 3 DIHAPUS PERMANEN)
    ...
    return RefreshIndicator(
      ...
      child: ListView(
        ...
        children: [
          ...
          // 🔥 GRAFIK PROGRESS BAR PINDAHAN DARI TAB 3 LAMA
          Container(
            padding: const EdgeInsets.all(20),
            decoration: BoxDecoration(
              color: Colors.white,
  ...
  Widget _buildManajemenAkunTab() {
    ...
    return ListView(
      ...
      children: [
        ...
        // 1. MANAJEMEN USER (ADMIN & KEPSEK READ-ONLY VIEW)
        _buildMenuButton(
        ...
        // 3. KEUANGAN & SPP (BISA DILIHAT KEPSEK, TAPI READ ONLY DI DALAMNYA)
        _buildMenuButton(
        ...
        // 5. REKAP ABSENSI BULANAN (PINDAHAN DARI TAB 3 LAMA)
        _buildMenuButton(
...
// =========================================================================
// REKAP AKUMULASI BULANAN (WITH KEPSEK READ-ONLY PROTECTOR)
// =========================================================================
...
// =========================================================================
// KASIR & ADMINISTRASI TATA USAHA (WITH KEPSEK READ-ONLY PROTECTOR)
// =========================================================================
...
// =========================================================================
// DETAIL KASIR DENGAN DUKUNGAN READ-ONLY UNTUK KEPSEK
// =========================================================================
