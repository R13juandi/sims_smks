...
class _SiswaDashboardState extends State<SiswaDashboard>
  ...
  Future<void> _loadSiswaData() async {
    ...
    try {
      ...
      _jadwalHariIni = _allJadwalAktif
              ...
              children: [
                ...
                _buildMenuCard(
                  ...
                  onTap: () => Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => JadwalSemingguSiswaScreen(
                        allJadwalDB: _allJadwalDB, 
                        biodataSiswa: _biodataSiswa,
                      ),
                    ),
                  ),
                ),
...
class _JadwalSemingguSiswaScreenState extends State<JadwalSemingguSiswaScreen> {
  ...
  void _generateDaftarPeriode() {
    ...
    // 🔥 BUG FIXED: Urutan Regex dibalik (dari yang terpanjang ke terpendek) agar tidak memotong sembarangan!
  ...
  void _filterJadwalLokal(Map<String, String> period) {
    ...
    List<Map<String, dynamic>> hasil = widget.allJadwalDB.where((j) {
        ...
        // 🔥 BUG FIXED: Menggunakan .contains untuk memastikan X TKJ cocok dengan X TKJ 1 / sebaliknya
        bool matchKelas = dbKelas.contains(tKelas) || tKelas.contains(dbKelas);
    ...
    // 🛡️ SMART FALLBACK Lapis 1: Jika admin TU lupa nulis tahun ajaran, dan ini semester Aktif
    ...
    showDialog(
      ...
      builder: (ctx) {
        return AlertDialog(
          ...
          title: const Row(
            children: [
              Icon(Icons.history_edu_rounded, color: Color(0xFF1E40AF), size: 24),
              SizedBox(width: 8),
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    dense: true,
                    leading: Icon(
                      isAktif ? Icons.calendar_month_rounded : Icons.history_rounded,
                    ...
                    // 🔥 TRIGGER PERUBAHAN DATA LOKAL SAAT DIKLIK
                    onTap: () {
                      Navigator.pop(ctx);
                      if (!isSelected) {
                        setState(() => _selectedPeriodeLabel = label);
                        _filterJadwalLokal(item);
                      }
                    },
                  ),
                );
      ...
      appBar: AppBar(
        title: Column(
          ...
          children: [
            ...
            Text(
              _selectedPeriodeLabel, // 🔥 SEKARANG AKAN TAMPIL: "XI TKJ - Ganjil 2026/2027 (Aktif)"
              style: TextStyle(
                fontSize: 11,
                color: isHistoriView ? Colors.orange.shade800 : Colors.blue.shade800,
        ...
        actions: [
          Container(
            ...
            child: ActionChip(
              ...
              avatar: Icon(
                isHistoriView ? Icons.history_rounded : Icons.filter_list_rounded,
                size: 16, color: const Color(0xFF1E40AF),
              ),
              label: const Text(
                'Histori',
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(16),
                        border: Border.all(
                          color: isHariIni ? const Color(0xFF3B82F6) : const Color(0xFFF1F5F9),
                      ...
                      child: Theme(
                        ...
                        child: ExpansionTile(
                          ...
                          leading: Icon(
                            ...
                            color: isHariIni ? const Color(0xFF3B82F6) : const Color(0xFFCBD5E1),
                          ),
                          title: Row(
                            ...
                            children: [
                              Text(
                                ...
                                style: TextStyle(
                                  ...
                                  color: isHariIni ? const Color(0xFF1D4ED8) : const Color(0xFF1E293B),
                                ),
                              ),
                              if (isHariIni)
                                Container(
                                  ...
                                  child: const Text(
                                    'HARI INI',
                                    style: TextStyle(
                                      fontSize: 9, fontWeight: FontWeight.bold, color: Color(0xFF1D4ED8),
                                    ),
                                  ),
                                ),
                            ],
                            ...
                            if (jadwals.isEmpty)
                              ...
                              ...jadwals.map((j) {
                                ...
                                return Container(
                                  ...
                                  padding: const EdgeInsets.all(14),
                                  decoration: BoxDecoration(
                                    color: isIstirahat ? Colors.orange.shade50 : const Color(0xFFF8FAFC),
                                    borderRadius: BorderRadius.circular(12),
                                    border: Border.all(
                                      color: isIstirahat ? Colors.orange.shade200 : const Color(0xFFE2E8F0),
                                    ),
                                  ),
                                  child: Row(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Container(
                                        padding: const EdgeInsets.all(10),
                                        decoration: BoxDecoration(
                                          color: isIstirahat ? Colors.orange.shade100 : const Color(0xFFDBEAFE),
                                          shape: BoxShape.circle,
                                        ),
                                        child: Icon(
                                          isIstirahat ? Icons.fastfood : Icons.menu_book_rounded,
                                          color: isIstirahat ? Colors.orange.shade800 : const Color(0xFF1E40AF),
                                          size: 20,
                                        ),
                                      ),
                                      const SizedBox(width: 14),
                                          ...
                                          children: [
                                            Text(
                                              ...
                                              style: TextStyle(
                                                ...
                                                color: isIstirahat ? Colors.orange.shade900 : const Color(0xFF0F172A),
                                              ),
                                            ),
                                            const SizedBox(height: 6),
                                            if (!isIstirahat) ...[
                                            ...
                                            Text(
                                              ...
                                              style: TextStyle(
                                                fontSize: 11,
                                                color: isIstirahat ? Colors.orange.shade800 : Colors.blue.shade700,
                                                fontWeight: FontWeight.bold,
                                              ),
                                            ),
                                          ],
      ...
      body: ListView(
        ...
        children: [
            ...
            child: Column(
              children: [
                Container(
                  ...
                  child: CircleAvatar(
                    radius: 40, backgroundColor: const Color(0xFF1E3A8A).withOpacity(0.1),
                    child: const Icon(Icons.person_rounded, size: 45, color: Color(0xFF1E3A8A)),
                  ),
                ),
                const SizedBox(height: 12),
                Text(
          ...
          Container(
            padding: const EdgeInsets.all(20),
            decoration: BoxDecoration(
              color: Colors.white, borderRadius: BorderRadius.circular(20), border: Border.all(color: const Color(0xFFF1F5F9)),
              boxShadow: [BoxShadow(color: Colors.black.withOpacity(0.01), blurRadius: 20, offset: const Offset(0, 4))],
            ),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                _itemProfil(Icons.badge_rounded, 'NIPD (Nomor Induk Peserta Didik)', nipd),
                const Divider(height: 24),
          ...
          Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                _itemProfil(Icons.credit_card_rounded, 'NIK (Nomor Induk Kependudukan)', nik),
                const Divider(height: 24),
                if (tempatLahir.trim().isNotEmpty) ...[
                  _itemProfil(Icons.cake_rounded, 'Tempat, Tanggal Lahir', '$tempatLahir, $tglLahirFormatted'),
                  const Divider(height: 24),
                ],
                ...
                const Divider(height: 24),
                _itemProfil(Icons.phone_android_rounded, 'Nomor Handphone Aktif', noHp),
                const Divider(height: 24),
